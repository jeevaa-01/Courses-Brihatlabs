import type { ContentBlock, Course, Lesson, QuizQuestion, Unit } from "../types/course";
import { fullStackCourse, mernStackCourse, softwareTestingCourse } from "./software-course-data";
import { seedSubjects } from "./course-subjects";
